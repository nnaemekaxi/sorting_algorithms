...
/**
* merger - recurrsive function utilizing merge sort algo
* @array: Array
* @low: Lowest index of split
...
void merger(int *array, int low, int high, int *temp)
{
	int middle;
	...
	{
		middle = ((high + low - 1) / 2);
		merger(array, low, middle, temp);
		merger(array, middle + 1, high, temp);
